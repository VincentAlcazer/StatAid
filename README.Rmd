...
If you encounter any problem with the software or find a bug, please report it by:

- Creating a [new issue](https://github.com/VincentAlcazer/StatAid/issues) on the Github page
- Trying to describe the problem/bug with reproductible steps
