...
You can install the development version from [GitHub](https://github.com/VincentAlcazer/StatAid) either by cloning the repository or directly by downloading the package in R:
