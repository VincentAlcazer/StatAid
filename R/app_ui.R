    ...
    dashboardPage(
      ...
      dashboardSidebar(
        sidebarMenu(id="tabs",
                    ...
                    menuItem("Univariate analysis & models", tabName="Model", icon = icon("long-arrow-alt-right"),
                             "Outcome (Y variable):",
                    ...
                    menuItem("Multivariate analysis & models", tabName="Multiv", icon = icon("arrows-alt-h"),
                             "Outcome (Y variable):",
      ...
      dashboardBody(
        ...
        tabItem(tabName = "Data", 
                fluidRow(
                  column(8, mod_Data_ui("Data_ui_1")
                  ), #column
                  column(2, 
                         absolutePanel(width = 200, draggable = T,
                                       style = "opacity: 0.85",
                                       wellPanel(
                                         fileInput("df", label = "File input",
                                                   accept = c(
        ...
        tabItem(tabName = "Explo", 
                fluidRow(
                  tabsetPanel(id = 'Explo', type = "tabs",
        ...
        tabItem(tabName = "Model_num_multi",
                fluidRow(
                  tabsetPanel(id = "Model", type = "tabs",
